...
export class Network extends ApiObject {
  ...
  /**
   * Adds "Network" kind and apiVersion to props
   * @param props initialization props
   */
  public static propsWithGVK(props: NetworkProps): any {
    return {
      ...props,
      kind: 'Network',
      apiVersion: 'aws.platformref.crossplane.io/v1alpha1',
  ...
  public constructor(scope: Construct, id: string, props: NetworkProps) {
    super(scope, id, Network.propsWithGVK(props));
  }
}
...
export class PostgreSqlInstance extends ApiObject {
  ...
  /**
   * Adds "PostgreSQLInstance" kind and apiVersion to props
   * @param props initialization props
   */
  public static propsWithGVK(props: PostgreSqlInstanceProps): any {
    return {
      ...props,
      kind: 'PostgreSQLInstance',
      apiVersion: 'aws.platformref.crossplane.io/v1alpha1',
  ...
  public constructor(scope: Construct, id: string, props: PostgreSqlInstanceProps) {
    super(scope, id, PostgreSqlInstance.propsWithGVK(props));
  }
}
