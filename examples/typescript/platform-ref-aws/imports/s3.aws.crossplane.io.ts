...
export class Bucket extends ApiObject {
  ...
  /**
   * Adds "Bucket" kind and apiVersion to props
   * @param props initialization props
   */
  public static propsWithGVK(props: BucketProps): any {
    return {
      ...props,
      kind: 'Bucket',
      apiVersion: 's3.aws.crossplane.io/v1beta1',
  ...
  public constructor(scope: Construct, id: string, props: BucketProps) {
    super(scope, id, Bucket.propsWithGVK(props));
  }
}
...
export class BucketPolicy extends ApiObject {
  ...
  /**
   * Adds "BucketPolicy" kind and apiVersion to props
   * @param props initialization props
   */
  public static propsWithGVK(props: BucketPolicyProps): any {
    return {
      ...props,
      kind: 'BucketPolicy',
      apiVersion: 's3.aws.crossplane.io/v1alpha2',
  ...
  public constructor(scope: Construct, id: string, props: BucketPolicyProps) {
    super(scope, id, BucketPolicy.propsWithGVK(props));
  }
}
