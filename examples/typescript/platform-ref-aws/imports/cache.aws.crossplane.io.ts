...
export class CacheCluster extends ApiObject {
  ...
  /**
   * Adds "CacheCluster" kind and apiVersion to props
   * @param props initialization props
   */
  public static propsWithGVK(props: CacheClusterProps): any {
    return {
      ...props,
      kind: 'CacheCluster',
      apiVersion: 'cache.aws.crossplane.io/v1alpha1',
  ...
  public constructor(scope: Construct, id: string, props: CacheClusterProps) {
    super(scope, id, CacheCluster.propsWithGVK(props));
  }
}
...
export class CacheSubnetGroup extends ApiObject {
  ...
  /**
   * Adds "CacheSubnetGroup" kind and apiVersion to props
   * @param props initialization props
   */
  public static propsWithGVK(props: CacheSubnetGroupProps): any {
    return {
      ...props,
      kind: 'CacheSubnetGroup',
      apiVersion: 'cache.aws.crossplane.io/v1alpha1',
  ...
  public constructor(scope: Construct, id: string, props: CacheSubnetGroupProps) {
    super(scope, id, CacheSubnetGroup.propsWithGVK(props));
  }
}
...
export class ReplicationGroup extends ApiObject {
  ...
  /**
   * Adds "ReplicationGroup" kind and apiVersion to props
   * @param props initialization props
   */
  public static propsWithGVK(props: ReplicationGroupProps): any {
    return {
      ...props,
      kind: 'ReplicationGroup',
      apiVersion: 'cache.aws.crossplane.io/v1beta1',
  ...
  public constructor(scope: Construct, id: string, props: ReplicationGroupProps) {
    super(scope, id, ReplicationGroup.propsWithGVK(props));
  }
}
