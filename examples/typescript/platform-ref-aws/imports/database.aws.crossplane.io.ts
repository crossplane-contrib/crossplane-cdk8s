...
export class DbSubnetGroup extends ApiObject {
  ...
  /**
   * Adds "DBSubnetGroup" kind and apiVersion to props
   * @param props initialization props
   */
  public static propsWithGVK(props: DbSubnetGroupProps): any {
    return {
      ...props,
      kind: 'DBSubnetGroup',
      apiVersion: 'database.aws.crossplane.io/v1beta1',
  ...
  public constructor(scope: Construct, id: string, props: DbSubnetGroupProps) {
    super(scope, id, DbSubnetGroup.propsWithGVK(props));
  }
}
...
export class DynamoTable extends ApiObject {
  /**
   * Returns the apiVersion and kind for "DynamoTable"
   */
  public static readonly GVK: GroupVersionKind = {
  ...
  /**
   * Adds "DynamoTable" kind and apiVersion to props
   * @param props initialization props
   */
  public static propsWithGVK(props: DynamoTableProps): any {
    return {
      ...props,
      kind: 'DynamoTable',
      apiVersion: 'database.aws.crossplane.io/v1alpha1',
  ...
  public constructor(scope: Construct, id: string, props: DynamoTableProps) {
    super(scope, id, DynamoTable.propsWithGVK(props));
  }
}
...
export class RdsInstance extends ApiObject {
  ...
  /**
   * Adds "RDSInstance" kind and apiVersion to props
   * @param props initialization props
   */
  public static propsWithGVK(props: RdsInstanceProps): any {
    return {
      ...props,
      kind: 'RDSInstance',
      apiVersion: 'database.aws.crossplane.io/v1beta1',
  ...
  public constructor(scope: Construct, id: string, props: RdsInstanceProps) {
    super(scope, id, RdsInstance.propsWithGVK(props));
  }
}
