...
export class HostedZone extends ApiObject {
  ...
  /**
   * Adds "HostedZone" kind and apiVersion to props
   * @param props initialization props
   */
  public static propsWithGVK(props: HostedZoneProps): any {
    return {
      ...props,
      kind: 'HostedZone',
      apiVersion: 'route53.aws.crossplane.io/v1alpha1',
  ...
  public constructor(scope: Construct, id: string, props: HostedZoneProps) {
    super(scope, id, HostedZone.propsWithGVK(props));
  }
}
...
export class ResourceRecordSet extends ApiObject {
  ...
  /**
   * Adds "ResourceRecordSet" kind and apiVersion to props
   * @param props initialization props
   */
  public static propsWithGVK(props: ResourceRecordSetProps): any {
    return {
      ...props,
      kind: 'ResourceRecordSet',
      apiVersion: 'route53.aws.crossplane.io/v1alpha1',
  ...
  public constructor(scope: Construct, id: string, props: ResourceRecordSetProps) {
    super(scope, id, ResourceRecordSet.propsWithGVK(props));
  }
}
...
export interface ResourceRecordSetSpec {
   ...
   * ProviderReference specifies the provider that will be used to create, observe, update, and delete this managed resource. Deprecated: Please use ProviderConfigReference, i.e. `providerConfigRef`
   *
   * @schema ResourceRecordSetSpec#providerRef
   */
  readonly providerRef?: ResourceRecordSetSpecProviderRef;
 ...
 * ProviderReference specifies the provider that will be used to create, observe, update, and delete this managed resource. Deprecated: Please use ProviderConfigReference, i.e. `providerConfigRef`
 *
 * @schema ResourceRecordSetSpecProviderRef
 */
export interface ResourceRecordSetSpecProviderRef {
  /**
   * Name of the referenced object.
   *
   * @schema ResourceRecordSetSpecProviderRef#name
   */
  readonly name: string;
