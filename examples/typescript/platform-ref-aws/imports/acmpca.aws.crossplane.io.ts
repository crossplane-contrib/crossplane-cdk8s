...
export class CertificateAuthority extends ApiObject {
  ...
  /**
   * Adds "CertificateAuthority" kind and apiVersion to props
   * @param props initialization props
   */
  public static propsWithGVK(props: CertificateAuthorityProps = {}): any {
    return {
      ...props,
      kind: 'CertificateAuthority',
      apiVersion: 'acmpca.aws.crossplane.io/v1alpha1',
  ...
  public constructor(scope: Construct, id: string, props: CertificateAuthorityProps = {}) {
    super(scope, id, CertificateAuthority.propsWithGVK(props));
  }
}
...
export class CertificateAuthorityPermission extends ApiObject {
  ...
  /**
   * Adds "CertificateAuthorityPermission" kind and apiVersion to props
   * @param props initialization props
   */
  public static propsWithGVK(props: CertificateAuthorityPermissionProps = {}): any {
    return {
      ...props,
      kind: 'CertificateAuthorityPermission',
      apiVersion: 'acmpca.aws.crossplane.io/v1alpha1',
  ...
  public constructor(scope: Construct, id: string, props: CertificateAuthorityPermissionProps = {}) {
    super(scope, id, CertificateAuthorityPermission.propsWithGVK(props));
  }
}
