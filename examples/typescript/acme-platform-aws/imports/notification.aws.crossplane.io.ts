...
export class SnsSubscription extends ApiObject {
  ...
  /**
   * Renders a Kubernetes manifest for "SNSSubscription".
   *
   * This can be used to inline resource manifests inside other objects (e.g. as templates).
   *
   * @param props initialization props
   */
  public static manifest(props: SnsSubscriptionProps): any {
    return {
      ...SnsSubscription.GVK,
      ...props,
    };
  ...
  public constructor(scope: Construct, id: string, props: SnsSubscriptionProps) {
    super(scope, id, SnsSubscription.manifest(props));
  }
}
...
export class SnsTopic extends ApiObject {
  ...
  /**
   * Renders a Kubernetes manifest for "SNSTopic".
   *
   * This can be used to inline resource manifests inside other objects (e.g. as templates).
   *
   * @param props initialization props
   */
  public static manifest(props: SnsTopicProps): any {
    return {
      ...SnsTopic.GVK,
      ...props,
    };
  ...
  public constructor(scope: Construct, id: string, props: SnsTopicProps) {
    super(scope, id, SnsTopic.manifest(props));
  }
}
