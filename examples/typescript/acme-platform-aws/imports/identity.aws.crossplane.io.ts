...
export class IamAccessKey extends ApiObject {
  ...
  /**
   * Renders a Kubernetes manifest for "IAMAccessKey".
   *
   * This can be used to inline resource manifests inside other objects (e.g. as templates).
   *
   * @param props initialization props
   */
  public static manifest(props: IamAccessKeyProps): any {
    return {
      ...IamAccessKey.GVK,
      ...props,
    };
  ...
  public constructor(scope: Construct, id: string, props: IamAccessKeyProps) {
    super(scope, id, IamAccessKey.manifest(props));
  }
}
...
export class IamGroup extends ApiObject {
  ...
  /**
   * Renders a Kubernetes manifest for "IAMGroup".
   *
   * This can be used to inline resource manifests inside other objects (e.g. as templates).
   *
   * @param props initialization props
   */
  public static manifest(props: IamGroupProps): any {
    return {
      ...IamGroup.GVK,
      ...props,
    };
  ...
  public constructor(scope: Construct, id: string, props: IamGroupProps) {
    super(scope, id, IamGroup.manifest(props));
  }
}
...
export class IamGroupPolicyAttachment extends ApiObject {
  ...
  /**
   * Renders a Kubernetes manifest for "IAMGroupPolicyAttachment".
   *
   * This can be used to inline resource manifests inside other objects (e.g. as templates).
   *
   * @param props initialization props
   */
  public static manifest(props: IamGroupPolicyAttachmentProps): any {
    return {
      ...IamGroupPolicyAttachment.GVK,
      ...props,
    };
  }
  ...
  public constructor(scope: Construct, id: string, props: IamGroupPolicyAttachmentProps) {
    super(scope, id, IamGroupPolicyAttachment.manifest(props));
  }
}
...
export class IamGroupUserMembership extends ApiObject {
  ...
  /**
   * Renders a Kubernetes manifest for "IAMGroupUserMembership".
   *
   * This can be used to inline resource manifests inside other objects (e.g. as templates).
   *
   * @param props initialization props
   */
  public static manifest(props: IamGroupUserMembershipProps): any {
    return {
      ...IamGroupUserMembership.GVK,
      ...props,
    };
  }
  ...
  public constructor(scope: Construct, id: string, props: IamGroupUserMembershipProps) {
    super(scope, id, IamGroupUserMembership.manifest(props));
  }
}
...
export class IamPolicy extends ApiObject {
  ...
  public constructor(scope: Construct, id: string, props: IamPolicyProps) {
    super(scope, id, IamPolicy.manifest(props));
  }
}
...
export class IamRole extends ApiObject {
  ...
  /**
   * Renders a Kubernetes manifest for "IAMRole".
   *
   * This can be used to inline resource manifests inside other objects (e.g. as templates).
   *
   * @param props initialization props
   */
  public static manifest(props: IamRoleProps): any {
    return {
      ...IamRole.GVK,
      ...props,
    };
  ...
  public constructor(scope: Construct, id: string, props: IamRoleProps) {
    super(scope, id, IamRole.manifest(props));
  }
}
...
export class IamRolePolicyAttachment extends ApiObject {
  ...
  /**
   * Renders a Kubernetes manifest for "IAMRolePolicyAttachment".
   *
   * This can be used to inline resource manifests inside other objects (e.g. as templates).
   *
   * @param props initialization props
   */
  public static manifest(props: IamRolePolicyAttachmentProps): any {
    return {
      ...IamRolePolicyAttachment.GVK,
      ...props,
    };
  }
  ...
  public constructor(scope: Construct, id: string, props: IamRolePolicyAttachmentProps) {
    super(scope, id, IamRolePolicyAttachment.manifest(props));
  }
}
...
export class IamUser extends ApiObject {
  ...
  /**
   * Renders a Kubernetes manifest for "IAMUser".
   *
   * This can be used to inline resource manifests inside other objects (e.g. as templates).
   *
   * @param props initialization props
   */
  public static manifest(props: IamUserProps): any {
    return {
      ...IamUser.GVK,
      ...props,
    };
  ...
  public constructor(scope: Construct, id: string, props: IamUserProps) {
    super(scope, id, IamUser.manifest(props));
  }
}
...
export class IamUserPolicyAttachment extends ApiObject {
  ...
  /**
   * Renders a Kubernetes manifest for "IAMUserPolicyAttachment".
   *
   * This can be used to inline resource manifests inside other objects (e.g. as templates).
   *
   * @param props initialization props
   */
  public static manifest(props: IamUserPolicyAttachmentProps): any {
    return {
      ...IamUserPolicyAttachment.GVK,
      ...props,
    };
  }
  ...
  public constructor(scope: Construct, id: string, props: IamUserPolicyAttachmentProps) {
    super(scope, id, IamUserPolicyAttachment.manifest(props));
  }
}
