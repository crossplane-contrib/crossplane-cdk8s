...
export function compositeclustersAwsPlatformrefCrossplaneIo(chart: Chart, name: string = 'compositeclusters.aws.platform.acme.io/compositeresourcedefinition/apiextensions.crossplane.io') : ApiObject {
...
export function compositepostgresqlinstancesAwsPlatformrefCrossplaneIo(chart: Chart, name: string = 'compositepostgresqlinstances.aws.platform.acme.io/compositeresourcedefinition/apiextensions.crossplane.io') : ApiObject {
  return new group.CompositeResourceDefinition(chart, name,
    {
      metadata: {
